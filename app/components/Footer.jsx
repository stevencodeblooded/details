...
const Footer = () => {
  ...
  return (
    <div className=" max-w-7xl mx-auto px-4 md:px-10 py-4 text-white flex flex-col gap-16">
      <div className="flex items-center justify-center py-16 bg-gradient-to-br from-gray-800 to-gray-900">
        <div className="w-full max-w-2xl p-8 rounded-lg shadow-lg">
          <div className="text-center">
            <h1 className="text-3xl lg:text-4xl lg:leading-snug font-bold w-full md:w-3/4 mx-auto text-white mb-8">
      ...
      <div className=" text-gray-300 p-4 relative overflow-hidden">
